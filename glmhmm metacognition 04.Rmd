...
DL. YO CREO QUE NO ES TAN RARO QUE EL ESTADO MENOS PRECISO SEA DOMINANTE
...
El eje y para los trials indica la respuesta, mientras que para los estados indica la probabilidad de estar en uno.
...
ESTE FIT ES EL QUE TIENES QUE UTILIZAR PARA TODOS LOS ANALISIS, POR EJ: 
```{r}
...
```{r}
averages_states2_S01 <- glm_hmm2_s01_best$model_matrix_with_session %>% 
    mutate(trial = row_number()) %>%
...
Me parece extraño que no haya puntos con valores más altos o bajos de dot_diff.
Me aparece el siguiente Warning: Ignoring unknown aesthetics: groups
```{r}
averages_states2_S01 |>
